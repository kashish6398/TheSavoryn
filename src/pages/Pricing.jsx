...
function Pricing() {
  const plans = [
    {
      name: "Basic Plan",
      description: "Perfect for startups and small businesses. Get access to local chef profiles.",
      price: "₹199/month",
      features: [
        "Access To 20 Chef Profiles Per Month.",
        "Limited Access To Industry Job Postings.",
        "Basic Support For Inquiries.",
      ],
    },
    {
      name: "Professional Plan",
      description: "Ideal for growing businesses or chefs looking for premium opportunities.",
      price: "₹499/month",
      features: [
    ...
    },
    {
      ...
      description: "Tailored for large-scale industries and premium chefs. Maximize your reach and hiring efficiency.",
      price: "₹999/month",
      features: [
        "Unlimited Chef Profiles And Postings.",
        "Featured Job Visibility.",
        "Analytics For Hiring Trends.",
        "24/7 Customer Support.",
      ],
    },
    {
      name: "Elite Chef Plan",
      description: "Showcase your culinary skills and connect with premium industries.",
      price: "₹199/month",
      features: [
        "Profile Visibility Boost For Industries.",
